...
!ifndef  VERSION
   !define  VERSION "1.7.5 Pro"
!endif

!define  REG_KEY  "SOFTWARE\Torque\${PRODUCT_NAME}_${VERSION}"

;Name and file
Name "${PRODUCT_NAME}_${VERSION}"
OutFile "..\${PRODUCT_NAME}_${VERSION}_Win.exe"
...
Section "!$(^Name) (required)" SecTorque
  ...
  WriteINIStr "$SMPROGRAMS\$(^Name)\$(^Name) Home Page.url" \
    "InternetShortcut" "URL" "http://www.garagegames.com/products/torque-2d/iphone"
  WriteINIStr "$SMPROGRAMS\$(^Name)\Online Documentation.url" \
    "InternetShortcut" "URL" "http://www.garagegames.com/products/torque-2d/iphone"
  WriteINIStr "$SMPROGRAMS\$(^Name)\$(^Name) Forums (online).url" \
    "InternetShortcut" "URL" "http://www.garagegames.com/community/forums/56"
...
Function .onInstSuccess
   ExecShell "open" "http://www.garagegames.com/products/torque-2d/iphone"
FunctionEnd
...
!insertmacro MUI_DESCRIPTION_TEXT ${SecTorque} "Install the iTorque 2D source code, binaries, and editor. This component is required."
!insertmacro MUI_DESCRIPTION_TEXT ${SecDesktop} "Create a shortcut on your desktop for launching the iTorque 2D Editor"
