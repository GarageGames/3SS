...
#ifdef _MSC_VER
#define PLATFORM_HALT	__debugbreak()
#else
#define PLATFORM_HALT	Platform::debugBreak()
#endif
...
public:
   ...
   #define AssertFatal(x, y)         \
         { if (((bool)(x))==(bool)0) \
            { if ( PlatformAssert::processAssert(PlatformAssert::Fatal, __FILE__, __LINE__,  y) ) { PLATFORM_HALT; } } }
