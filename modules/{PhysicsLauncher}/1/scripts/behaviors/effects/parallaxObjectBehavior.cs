...
function ParallaxObjectBehavior::onUpdate(%this)
{
	...
	// set the position intead of the scroll amount. this is easier to calculate.
	%this.owner.setPosition(getWord(%this.owner.position, 0) + %horizontalScrollRate, getword(%this.owner.position, 1) + %verticalScrollRate);
